      ...
      <div className="bg-stone-950 min-h-screen">
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                  ...
                  <div>
                     <div className="mb-8 flex justify-between items-end">
                        ...
                        <Link href="/shop/copper" className="text-copper-400 text-xs uppercase tracking-widest hover:text-white transition-colors">View All</Link>
                     </div>
                  ...
                  <div>
                     <div className="mb-8 flex justify-between items-end">
                        ...
                        <Link href="/shop/fire" className="text-copper-400 text-xs uppercase tracking-widest hover:text-white transition-colors">View All</Link>
                     </div>
                     <div className="grid grid-cols-2 gap-6">
                        {fireProducts.map(p => (
                           <ProductCard key={p.id} product={p} />
            ...
            <div className="relative z-10 max-w-7xl mx-auto">
               <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="py-24 px-6 md:px-12 lg:py-32 flex flex-col justify-center">
                     ...
                     <Link href="/about" className="inline-block border-b border-copper-500 pb-1 text-copper-400 hover:text-white transition-colors uppercase tracking-widest text-xs self-start font-bold">
                        Read Our Story
                     </Link>
                  </div>
         ...
         <section className="py-32 px-6 bg-stone-950 border-t border-stone-900">
            <div className="max-w-4xl mx-auto text-center">
               ...
               <Link href="/about" className="px-12 py-4 bg-white text-stone-950 hover:bg-copper-500 hover:text-white transition-colors uppercase tracking-widest text-xs font-bold">
                  Read Our Full Story
               </Link>
            </div>
         </section>
