    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative h-full flex flex-col justify-center items-center text-center px-4">
        ...
        <div className="flex flex-col md:flex-row gap-6 animate-slide-up opacity-0" style={{ animationDelay: '0.8s' }}>
          <Link href="/shop/copper" className="group relative px-8 py-4 bg-copper-600 text-white font-medium uppercase tracking-widest text-xs hover:bg-copper-500 transition-all overflow-hidden">
          ...
          <Link href="/shop/fire" className="group px-8 py-4 border border-stone-500 text-white font-medium uppercase tracking-widest text-xs hover:border-white hover:bg-white hover:text-stone-950 transition-all">
            Shop Fire Starters
          </Link>
        </div>
      </div>
