...
export default function Navbar() {
  ...
  const navClass = `fixed w-full z-50 transition-all duration-500 ${isScrolled ? 'bg-stone-950/90 backdrop-blur-md py-4 border-b border-stone-800' : 'bg-transparent py-6'
    }`;
